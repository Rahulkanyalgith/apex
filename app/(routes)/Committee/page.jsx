...
function page() {
    return (
        <div className="flex flex-col items-center justify-center w-full min-h-screen py-20 bg-gradient-to-b via-green-50 to-white from-white">
            <div className="flex flex-col w-11/12 gap-20">
                <div className="flex flex-col justify-end w-11/12 leading-none tracking-tighter">
                    <h1 className="text-[3.5rem] sm:text-[5rem] md:text-[7rem] lg:text-[9rem] font-black text-neutral-700">Our Committees</h1>
                    <h1 className="text-[1.3rem] md:text-[2rem] font-medium text-neutral-700">Shaping Tomorrow's Leaders 🤟</h1>
                </div>
                    ...
                    {Committees.map((data, index) => (
                        <div className="relative flex flex-col h-full gap-10 p-8 duration-300 border hover:border-green-500 hover:scale-95 rounded-xl" key={index}>
                            ...
                            <div className="flex flex-col gap-2">
                                <h1 className="text-[2rem] font-black text-neutral-700">{data.title}</h1>
                                <p className="font-mono font-medium text-neutral-700">{data.desc}</p>
                            </div>
                        </div>
                    ))}
                </div>
